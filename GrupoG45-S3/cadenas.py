...
animal = "cocodrilo"
print(animal[4])
print(len(animal)) # len es una función que nos devuelve la longitud 
...
print(animal[-3]) # las posiciones negativas van de derecha a izquierda
print(animal[-4]) # las posiciones negativas van de derecha a izquierda
