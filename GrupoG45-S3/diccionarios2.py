...
#setdefault
print(datosPersonales.setdefault('email','prueba@gmail.com'))
print(datosPersonales.setdefault('silla', 45)) #setdafault si no existe un elemento lo crea
datosPersonales['cargo'] = 'Operario'
print(datosPersonales)

for llave, valor in datosPersonales.items():
    print(llave, valor)
